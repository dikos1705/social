...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    profile_avatar = models.ImageField(blank=True, upload_to="photos/%Y/%m/%d/",default='photos/default_profile.png')
    followers = models.ManyToManyField('self',blank=True,symmetrical=True)
